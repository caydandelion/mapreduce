...
/**
 * ÔÚÊÕÁ²ÌõŒþÂú×ãÇÒËùÓÐŽØÖÐÐÄµÄÎÄŒþ×îºó²úÉúºó£¬ÔÙ¶ÔÊäÈëÎÄŒþ
 * ÖÐµÄËùÓÐÊµÀýœøÐÐ»®·ÖŽØµÄ¹€×÷£¬×îºó°ÑËùÓÐÊµÀý°ŽÕÕ(ÊµÀý,ŽØid)
 * µÄ·œÊœÐŽœøœá¹ûÎÄŒþ
 * @author KING
 *
 */
public class KMeansCluster {
	public static class KMeansClusterMapper extends Mapper<LongWritable, Text, Text, IntWritable>{
		...
		/**
		 * ¶ÁÈ¡Ò»ÐÐÈ»ºóÑ°ÕÒÀëžÃµã×îœüµÄŽØid·¢Éä(instance,clusterID)
		 */
		@Override
